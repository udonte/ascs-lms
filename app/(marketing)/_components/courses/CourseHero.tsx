    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            Learn <span className="text-customer-gold">Customer Success</span>{" "}
            from Africa's Premier School
          </motion.h1>
          ...
          >
            Elevate your career with our industry-recognized courses designed to
            equip you with practical skills and knowledge in Customer Success.
          </motion.p>
          ...
          >
            If you're starting out or looking to advance your expertise, our
            comprehensive curriculum, taught by seasoned professionals, will
            prepare you for success in the dynamic field of Customer Success.
          </motion.p>
            ...
            <div className="relative bg-linear-to-br from-customer-purple/80 to-customer-teal/60 rounded-2xl p-8 backdrop-blur-sm border border-customer-cream/10">
              <div className="bg-customer-charcoal/30 rounded-xl h-96 lg:h-[500px] flex items-center justify-center border-2 border-customer-gold/20 overflow-hidden">
                <div className="relative w-full h-full">
                  <Image
                    src="/assets/course/course-hero.png"

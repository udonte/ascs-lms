...
export default function MagazinePodcastSection() {
                ...
                >
                  <div className="relative rounded-xl overflow-hidden shadow-lg">
                    <div className="bg-linear-to-br from-customer-purple/20 to-customer-gold/10 flex items-center justify-center">
                      <div className="relative z-10 p-4 lg:p-8 h-96 lg:h-[600px] w-full">
                        <div className="relative w-full h-full">
                          <Image
                            src="/assets/contact/magazine.png"
                            alt="SUCCESS+ Digest Magazine"
                            fill
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Button variant="primary" icon={<FaBookOpen />}>
                      <a href="https://selar.com/42aii25n71" target="_blank" rel="noreferrer">
                        Get Magazine
                      </a>
                    </Button>
                  </div>
              ...
              <div className="flex flex-col justify-center p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <Button variant="primary" icon={<FaHeadphones />}>
                    <a
                      href="https://youtube.com/@theafricanschoolofcs?si=N6mlswgy4ldVyNSO"
                      target="_blank"
                      rel="noreferrer"
                    >
                    ...
                    <div className="bg-customer-cream/30 rounded-xl p-6">
                      ...
                      <ul className="space-y-2">
                        {[
                          ...
                          "Practical advice for career growth in the African market",
                        ].map((text) => (
                          <li key={text} className="flex items-start gap-3">
                            <div className="w-2 h-2 bg-customer-gold rounded-full mt-2 shrink-0" />

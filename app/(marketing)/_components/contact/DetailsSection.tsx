...
export default function DetailsSection() {
  ...
  const itemVariants = {
    ...
    visible: {
      opacity: 1,
      y: 0,
      transition: { duration: 0.6, ease: dynamicEast as Easing },
    },
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl border border-customer-purple/10 p-8 lg:p-10">
              <div className="absolute top-0 left-0 right-0 h-2 bg-linear-to-r from-customer-purple to-customer-gold rounded-t-2xl" />
                      ...
                      <div>
                        ...
                        <div className="space-y-1 mb-2 w-full">
                          {info.details.map((detail) => (
                            <p
                              key={detail}
                              className="text-customer-charcoal/80 font-medium text-[10px] md:text-sm whitespace-normal wrap-break-word"
                            >
                              {detail}
                            </p>
                          ))}
            ...
            <div className="absolute -z-10 top-6 -right-6 w-64 h-64 bg-customer-gold/10 rounded-full blur-2xl" />
            <div className="absolute -z-10 bottom-6 -left-6 w-80 h-80 bg-customer-purple/10 rounded-full blur-2xl" />
          </motion.div>
              ...
              <div className="relative h-[500px]">
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-8 border-r-8 border-t-8 border-l-transparent border-r-transparent border-t-customer-purple" />
                  </div>
                </motion.div>
              </div>

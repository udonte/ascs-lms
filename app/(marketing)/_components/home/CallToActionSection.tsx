  ...
  return (
    ...
    >
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-customer-cream/20 rounded-full mix-blend-soft-light filter blur-xl animate-pulse delay-1000" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-customer-gold/20 rounded-full mix-blend-soft-light filter blur-xl animate-pulse delay-500" />
      </div>

    ...
    <section className="py-20 bg-white" id="mission-vision">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <motion.div
            className="relative bg-linear-to-br from-customer-purple to-purple-800 rounded-2xl p-8 text-customer-cream"
            variants={containerVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-50px" }}
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-customer-gold/20 rounded-full -translate-y-16 translate-x-16 blur-2xl" />
            <div className="absolute bottom-0 left-0 w-40 h-40 bg-customer-teal/20 rounded-full translate-y-16 -translate-x-16 blur-2xl" />
            ...
            <motion.div
              className="absolute bottom-0 left-1/2 -translate-x-1/2 w-32 h-1 bg-customer-gold rounded-full"
              variants={itemVariants}
            />
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="absolute top-0 left-0 w-32 h-32 bg-customer-gold/20 rounded-full -translate-y-16 -translate-x-16 blur-2xl" />
            <div className="absolute bottom-0 right-0 w-40 h-40 bg-customer-purple/20 rounded-full translate-y-16 translate-x-16 blur-2xl" />

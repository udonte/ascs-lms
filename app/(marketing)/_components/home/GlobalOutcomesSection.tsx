...
export default function GlobalOutcomesSection() {
  ...
  const studentStories = [
    ...
    },
    {
      ...
      image: "/assets/students/Olajumoke-Akinmade..jpeg",
      quote:
    ...
    },
    {
      id: 3,
      name: "Weli Sonia",
      image: "/assets/students/Sonia-Weli.jpeg",
      quote:
    ...
    },
    {
      id: 4,
      name: "Lilian Uma",
      image: "/assets/students/Lilian-testimony.png",
      quote:
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <motion.div variants={itemVariants} className="relative">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center max-w-6xl mx-auto">
              ...
              >
                <div className="text-center">
                  <div className="flex items-center justify-center mx-auto mb-4">
                    <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-customer-purple/30 group-hover:border-customer-purple/50 transition-all duration-300 relative">
                      <Image
                        ...
                        sizes="80px"
                        unoptimized={visibleStories[0].image.startsWith("http")}
                      />
                    </div>
                  </div>
              ...
              >
                <div className="text-center">
                  <div className="flex items-center justify-center mx-auto mb-4">
                    <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-customer-gold/30 group-hover:border-customer-gold/50 transition-all duration-300 relative">
                      <Image
                        ...
                        className="object-cover"
                        sizes="96px"
                        unoptimized={visibleStories[1].image.startsWith("http")}
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-center mx-auto mb-4">
                    <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-customer-purple/30 group-hover:border-customer-purple/50 transition-all duration-300 relative">
                      <Image
                        ...
                        className="object-cover"
                        sizes="80px"
                        unoptimized={visibleStories[2].image.startsWith("http")}
                      />
                    </div>
                  </div>
            ...
            <button
              onClick={prevSlide}
              className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 p-3 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-white transition-all duration-300 group border border-customer-purple/10 cursor-pointer z-20"
            ...
            <button
              onClick={nextSlide}
              className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 p-3 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-white transition-all duration-300 group border border-customer-purple/10 cursor-pointer z-20"
          ...
          <motion.div variants={itemVariants} className="text-center mt-12">
            <Button href="/courses" variant="primary" size="lg" className="mx-auto">

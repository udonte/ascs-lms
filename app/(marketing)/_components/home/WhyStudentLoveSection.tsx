        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden">
              <div className="absolute inset-0 bg-linear-to-br from-customer-gold/20 to-customer-purple/10 backdrop-blur-sm border border-white/20 rounded-2xl" />
              ...
              <div className="relative z-10 h-96 lg:h-[500px] bg-linear-to-br from-customer-gold/10 to-customer-charcoal/10 rounded-2xl flex items-center justify-center">
                <div className="relative w-full h-full">
                  <Image
                    src="/assets/home/WhyStudentsLove.png"
            ...
            <div className="absolute -z-10 top-8 -left-8 w-72 h-72 bg-customer-purple/10 rounded-full blur-2xl" />
            <div className="absolute -z-10 bottom-8 -right-8 w-96 h-96 bg-customer-gold/10 rounded-full blur-2xl" />

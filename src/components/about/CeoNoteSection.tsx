            ...
            <div className="grid grid-cols-1 lg:grid-cols-3">
              ...
              <div className="bg-customer-purple  p-8 flex flex-col items-center justify-center text-customer-cream relative">
                ...
                <div className="relative z-10 text-center">
                  <div className="w-52 h-52 bg-customer-gold rounded-full flex items-center justify-center mx-auto mb-6 border-4 border-white/30">
                    <img
                      src={Founder}
                      alt="Gloria Michael, CEO"
                      className="w-full h-full rounded-full object-cover border-2 border-customer-charcoal/50 inset-2.5 drop-shadow-sm"
                    />
                  </div>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mt-8 pt-6 border-t border-customer-gold/30">
                <div className="inline-flex items-center gap-3">
                  <span className="font-playfair text-lg text-customer-charcoal">
